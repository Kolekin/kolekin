...
class CrudCode extends CCodeModel
{
	...
	public function getControllerFile()
	{
		...
		/*** start editan aaiyo ****/
		$modelpath = str_replace('//','/',str_replace(array('application','.','models',$this->getModelClass()),array('','/','',''),$this->model));
		$modelpath = str_replace('/',DIRECTORY_SEPARATOR,$modelpath);
		
		return Yii::app()->getBasePath().$modelpath.'controllers'.'/'.$id.'Controller.php';
		/*** end editan aaiyo ****/
	}
	...
	public function getViewPath()
	{
		...
		return Yii::app()->getBasePath().$modelpath.'views'.'/'.$this->getControllerID();
		/*** end editan aaiyo ****/
	}
