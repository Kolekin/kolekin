...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>KP3K Kementrian Kelautan dan Perikanan</title>
 ...
 <!--    // <script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.5.0/jquery.min.js"></script>
	...
	<?php  
	  ...
	  $cs->registerCssFile($baseUrl.'/css/introjs.min.css');
    $cs->registerCssFile($baseUrl.'/js/jquery-ui-1.11.1/jquery-ui.css');
    ...
    $cs->registerScriptFile($baseUrl.'/js/jquery-ui-1.11.1/jquery-ui.js');
	  $cs->registerScriptFile($baseUrl.'/js/plugins/jquery.masonry.min.js');
	  $cs->registerScriptFile($baseUrl.'/js/styleswitcher.js');
	  $cs->registerScriptFile($baseUrl.'/js/intro.min.js');
	  $cs->registerScriptFile($baseUrl.'/js/YiiIntroJS.js');
	?>
  </head>
