...
class <?php echo $this->controllerClass; ?> extends <?php echo (Yii::app()->getModule('rights')? 'RController':$this->baseControllerClass)."\n"; ?>
{
	/**
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow admin user to perform 'admin' and 'delete' actions
				...
				<?php if (Yii::app()->getModule('rights')) { ?>
				'users'=>array('*'),
	...
	public function actionBuat()
	{
		...
		if(isset($_POST['<?php echo $this->modelClass; ?>']))
		{
			...
			if($model->save())
				$this->redirect(array('lihat','id'=>$model-><?php echo $this->tableSchema->primaryKey; ?>));
		}
